...
<body class="font-sans antialiased bg-gray-900 text-gray-100 overflow-x-hidden min-h-screen w-full">
    ...
    <div class="flex w-full min-h-screen">
        ...
        <main id="main-content" class="flex-1 w-full max-w-full min-h-screen flex flex-col bg-[#0d1117] p-0 m-0 relative z-10 transition-all duration-200" style="margin-left:220px;">
