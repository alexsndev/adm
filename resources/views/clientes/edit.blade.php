            ...
            <form action="{{ route('clientes.update', $cliente->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="w-24 h-24 bg-gray-200 rounded-full flex items-center justify-center overflow-hidden">
                                @if($cliente->photo)
                                    <img id="photo-preview" src="{{ Storage::url($cliente->photo) }}" 
                                         alt="Foto do cliente" class="w-full h-full object-cover">
                                @else
                            ...
                            <div class="flex-1">
                                ...
                                @if($cliente->photo)
                                    <p class="text-xs text-blue-600 mt-1">Foto atual será substituída</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="company" name="company" value="{{ old('company', $cliente->company) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="tax_id" name="tax_id" value="{{ old('tax_id', $cliente->tax_id) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="hourly_rate" name="hourly_rate" value="{{ old('hourly_rate', $cliente->hourly_rate) }}" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="address" name="address" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('address', $cliente->address) }}</textarea>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="notes" name="notes" rows="4"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('notes', $cliente->notes) }}</textarea>
                    </div>
                </div>
