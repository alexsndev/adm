        ...
        @if($tarefas->count())
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                @foreach($tarefas as $tarefa)
                    ...
                    @endphp
                    <div class="rounded-2xl shadow-xl bg-gradient-to-br from-blue-100 via-white to-blue-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 border border-blue-200 dark:border-gray-700 p-6 flex flex-col justify-between relative">
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            @endif
                            <div class="flex-1">
                                <div class="font-bold text-lg text-gray-900 dark:text-gray-100">{{ $tarefa->title }}</div>
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <div class="flex gap-2">
                                ...
                                <a href="{{ route('tarefas.show', $tarefa) }}" class="inline-flex items-center px-3 py-1 bg-blue-500 hover:bg-blue-700 text-white font-bold rounded-lg shadow transition text-xs"><i class="fa-solid fa-eye mr-1"></i> Detalhes</a>
                            </div>
                        </div>
                    </div>
                @endforeach
