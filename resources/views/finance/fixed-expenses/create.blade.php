...
<div class="container mx-auto py-6 max-w-lg">
    <h1 class="text-2xl font-bold mb-6">Nova Despesa Fixa</h1>
    <form action="{{ route('finance.fixed-expenses.store') }}" method="POST" class="bg-gray-800 rounded shadow p-6">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            <label class="block mb-1 font-semibold text-white">Data inicial (primeiro pagamento)</label>
